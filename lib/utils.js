          ...
          try {
              if (x > 0) {
                  ...
                  if (attachements && attachements.Content[x] && attachements.Content[x].Files) {
                      ...
                      let _index = preformats.push(`\\placeoriginal{${attachements.Content[x].Files.Original}}{${localfile}}{${module.texEscape(attachements.Content[x].Captions[0])}}{${s}}{${_landscape}}{${module.texEscape(attachements.Content[x].Captions[1])}}{${settings._id}-${settings._name}-${x}}`)
                      return `---preformatter---${(_index-1)}-`;   
                  }    
              }
          }
