module.exports = function(log, slack) {
  ...
  module.md2Tex =  function(string, levelStyles) {
    ...
    var preformatting = function(text) {
      ...
      text = text.replace(/\\\[[fn|footnote]:(.*?)\\\]/g, function myFunction(_, x){
      ...
      text = text.replace(/\\\[[in|index]:(.*?)\\\]/g, function myFunction(_, x){
      ...
      text = text.replace(/\\\[description:(.*?)\\\]/gm, function myFunction(_, x){
